#!/usr/bin/env python3
"""
scrape_ojogo.py — Download O Jogo front pages from sapo.pt for the past N days.

Usage:
  python3 scrape_ojogo.py 7          # last 7 days
  python3 scrape_ojogo.py 7 --debug  # also save raw HTML to debug/<date>.html
"""
...
SLUG        = "ojogo"
URL_PATTERN = "https://sapo.pt/noticias/jornais/desporto/o-jogo-4138/{date}"
...
def main():
    ...
    if not args:
        print("Usage: python3 scrape_ojogo.py <days> [--debug]")
        print("  e.g. python3 scrape_ojogo.py 7")
        sys.exit(1)
