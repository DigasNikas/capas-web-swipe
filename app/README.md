...
Cloudflare Pages project `capas-app`, deployed at `app.capas.digasnikas.com`, behind Cloudflare Access. One page, the swipe app, with account/leaderboard/instructions/settings as modals rather than separate routes. Native ES modules, no build step.
