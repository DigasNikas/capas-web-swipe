...
Data sources: [football-data.org](https://www.football-data.org) (Primeira Liga, Champions League), [match.uefa.com](https://match.uefa.com) (all three European competitions, qualifying rounds included) and [api-sports.io](https://dashboard.api-football.com) (Taça de Portugal, Taça da Liga).
