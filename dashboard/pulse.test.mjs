...
assert.equal(
  ...
  'Porto foi o único a jogar Champions League e não foi manchete em todas as capas',
);

// Matches imported before the competition column existed.
assert.equal(
  pulseMessage(['Porto'], { onlyOne: true, competition: null }),
  'Porto foi o único a jogar e não foi manchete em todas as capas',
);
