...
| `import_matches.py` | Import match dates into D1 (football-data.org + match.uefa.com + api-sports.io). No season argument means the season happening now | Import Match Dates (weekly, Mondays 04:00 UTC + manual) |
