#!/usr/bin/env python3
"""
scrape_abola.py — Download A Bola front pages from sapo.pt for the past N days.

Usage:
  python3 scrape_abola.py 7          # last 7 days
  python3 scrape_abola.py 7 --debug  # also save raw HTML to debug/<date>.html
"""
...
SLUG        = "abola"
URL_PATTERN = "https://sapo.pt/noticias/jornais/desporto/a-bola-4137/{date}"
...
def main():
    ...
    if not args:
        print("Usage: python3 scrape_abola.py <days> [--debug]")
        print("  e.g. python3 scrape_abola.py 7")
        sys.exit(1)
