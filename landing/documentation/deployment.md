...
Deployed automatically by the two git-connected Cloudflare Pages projects (`capas-landing`, `capas-app`) on every push to this branch — no build step, no GitHub Actions workflow involved. See [Frontend](#frontend) for what each project serves.
